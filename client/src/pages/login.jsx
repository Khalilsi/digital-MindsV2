      ...
      <div className="relative z-20 w-full max-w-sm bg-white rounded-3xl border-8  shadow-2xl overflow-hidden animate-fadeIn">
        ...
        <div className="p-8 space-y-4">
          ...
          <div className="space-y-1">
            <label className="text-sm font-luckiest text-[#5d3a1a] uppercase ml-2">Username</label>
            <input 
              type="text" 
              placeholder="NAME..." 
              className="w-full p-3 bg-gray-100 border-4 border-gray-300 rounded-2xl text-center font-luckiest text-lg focus:border-cr-blue focus:outline-none transition-all placeholder:opacity-30"
            />
          </div>

          {/* Password Field */}
          <div className="space-y-1">
            <label className="text-sm font-luckiest text-[#5d3a1a] uppercase ml-2">Password</label>
            <input 
              type="password" 
              placeholder="••••••••" 
              className="w-full p-3 bg-gray-100 border-4 border-gray-300 rounded-2xl text-center font-luckiest text-lg focus:border-cr-blue focus:outline-none transition-all placeholder:opacity-30"
